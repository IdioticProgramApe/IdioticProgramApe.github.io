...
Frame rate and frame time are inversely proportional $\displaystyle\frac{1}{FPS} \cdot 1000 = MS$, by just giving out how many fps we save from an optimization, we cannot know how many time we save, save 30 fps it could be:
